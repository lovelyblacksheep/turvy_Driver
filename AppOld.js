...
import Constant from './driver/Constant'
...
import BookingMapStep1 from './driver/BookingMapStep1';
...
import VideoCall from './driver/video/VideoCall';
...
const CombinedDefaultTheme = merge(MyTheme, theme);
    ...
    return (
        <>
            ...
            <Stack.Navigator initialRouteName="LoginOtp">
                ...
                <Stack.Screen name="LocationEnableScreen" component={LocationEnableScreen} options={{title:'Login',headerShown:false}}  />
                ...
                <Stack.Screen name="BookingMapStep1" component={BookingMapStep1} options={{headerShown:false}}  />
                ...
                <Stack.Screen name="VideoCall" component={VideoCall} options={{title:'VideoCall',headerShown:false}}  />
