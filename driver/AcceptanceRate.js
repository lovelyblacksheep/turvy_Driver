...
export default class AcceptanceRate extends React.Component {
                ...
                <ScrollView>
                    ...
                    <View style={styles.content}>
                        <View style={{alignItems:'center',flexDirection:'row',justifyContent:'center'}}>
                            <View style={{flex:2,alignItems:'flex-start'}}>
                                <Text>Trips Requested</Text>
                            </View>
                            <View style={{flex:1,alignItems:'flex-end'}}>
                                <Text>{this.state.rateData.totalRequest}</Text>
                            </View>    
                        </View>
                    </View>
                    ...
                    <View style={styles.content}>
                        <View style={{alignItems:'center',flexDirection:'row',justifyContent:'center'}}>
                            ...
                            <View style={{flex:1,alignItems:'flex-end'}}>
                                <Text>{this.state.rateData.tripDecline}</Text>
                            </View>    
                        </View>                        
                    </View>                    
                </ScrollView>
