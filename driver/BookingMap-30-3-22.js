...
import { StyleSheet, Text, View,Dimensions, Image, TouchableOpacity,TouchableHighlight, Alert,Linking, BackHandler, Animated, AppState, Pressable, DeviceEventEmitter} from 'react-native';
    ...
    render() {
        ...
        return (
            <>
                ...
                ?
                <View style={{position:'absolute', zIndex: 100, top:'14%',left:0, right: 0, width: '100%', alignItems:'center', height: 'auto', backgroundColor: 'transparent' }}>
                    <View style={{width:'90%', flexDirection:'row',alignItems:'center', justifyContent:'space-between', height: '100%', backgroundColor: "#135aa8",borderRadius: moderateScale(10), paddingHorizontal: moderateScale(15),paddingVertical: moderateScale(10)}}>
