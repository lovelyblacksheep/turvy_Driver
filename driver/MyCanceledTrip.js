...
export default class MyCanceledTrip extends React.Component{    
    ...
    getMyRider = (page) => {
        ...
        fetch(`${DOMAIN}api/driver/canceled-trip/${page}`,{
            method: 'GET', 
            headers: new Headers({
            ...
            if(result.status === 1){    
                ...
                this.setState({
                    spinner:false,
                    loadingText: 'You have no canceled trips.'
                }); 
            }
                                                ...
                                                <View style={{alignContent:'center',justifyContent:'center',flex:1,flexDirection:'row'}}>
                                                    <Row style={{flex:1,alignItems:'center',justifyContent:'center'}}>
                                                        ...
                                                        <Col>
                                                            ...
                                                            <Text style={{fontSize:14}}>A$0.00</Text>
                                                        </Col>
